...
#######################################################################
def change_color(color1, color2, t):#changeing color
...
#                     interpolated_color = change_color(point.original_color, (0.0, 0.0, 0.0), t)
#                 else:
#                     interpolated_color = change_color((0.0, 0.0, 0.0), point.original_color, t)
